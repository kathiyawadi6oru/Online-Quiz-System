        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
                    ...
                    $query = "select faculty_permission.fac_per_id,faculty.f_id,faculty.f_code,faculty.f_name,subject.sub_id,subject.sub_code,subject.sub_name,semester.sem_id,semester.sem_code,course.course_id,course.course_code,course.course_name from faculty_permission inner join faculty on faculty.f_id=faculty_permission.f_id join subject on subject.sub_id=faculty_permission.sub_id inner join semester on semester.sem_id=subject.sem_id inner join course on course.course_id=semester.course_id where faculty_permission.fac_per_id ='$d'; ";
