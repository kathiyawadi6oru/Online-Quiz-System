        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
                    ...
                    $query = "select subject.sub_code,subject.sub_name,semester.sem_id,semester.sem_code,course.course_id,course.course_code,course.course_name from subject inner join semester on semester.sem_id=subject.sem_id join course on semester.course_id=course.course_id where subject.sub_id='$d';";
