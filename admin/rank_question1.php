            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Rank</h3>
                        <ol class="breadcrumb">
										...
										<table class="table table-bordered" style="text-align:center;">
											...
											<tbody>
												<tr>
													...
													<td><a href="ramk_choice1.php?id=<?php echo $row['sub_quiz_id'];?>" style="color:orange;text-decoration:none;"><i class="fa fa-eye m-r-10" style="font-size:18px" aria-hidden="true"></i></a></td>
												</tr>
											<?php
                                                    $no++;
												}
