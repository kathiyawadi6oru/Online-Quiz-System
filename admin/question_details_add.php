            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">question Details</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../admin/main.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="../admin/question_details.php">question Details</a></li>
                            ...
                            <div class="card-block">
                                <div class="row">
									...
									<div class="col-md-6  text-center">
										<form action="question_details_add_val.php" method="post">
                                           ...
                                           <label for="subject" style="color:blue;font-size:20px;">select Subject</label>
                                            ...
                                            <input type="text" class="form-control" name="quiz_no" required><br><br>
