											...
											<table class="table table-bordered" style="text-align:center;">
												<thead>
													...
													<?php
														...
														$sql = "select faculty_permission.fac_per_id,faculty.f_code,faculty.f_name,subject.sub_code,subject.sub_name,semester.sem_code,course.course_name from faculty_permission inner join faculty on faculty.f_id=faculty_permission.f_id join subject on subject.sub_id=faculty_permission.sub_id inner join semester on semester.sem_id=subject.sem_id  inner join course on course.course_id=semester.course_id where faculty.f_id='$f_id' order by faculty.f_code,subject.sub_code;";
