                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
								...
								<div class="row">
									<div class="col-md-12">
										<h2 class="text-danger text-center">Feedback Details</h2>
										<table class="table table-bordered" style="text-align:center;">
											...
											<?php
												...
												$sql = "select feedback.fb_id,feedback.title,feedback.comment,student.stud_code,student.stud_name,semester.sem_code,course.course_code,course.course_name from feedback inner join student on student.stud_id=feedback.stud_id inner join semester on semester.sem_id=student.sem_id inner join course on course.course_id=semester.course_id order by student.stud_code;";
											...
											<tbody>
												<tr>
                                                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["fb_id"]; ?>"></td>
