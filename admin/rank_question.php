										...
										<table class="table table-bordered" style="text-align:center;">
											...
											<tbody>
												<tr>
													...
													<td><a href="ramk_choice.php?id=<?php echo $row['sub_quiz_id'];?>" style="color:orange;text-decoration:none;"><i class="fa fa-eye m-r-10" style="font-size:18px" aria-hidden="true"></i></a></td>
												</tr>
											<?php
                                                    $no++;
												}
