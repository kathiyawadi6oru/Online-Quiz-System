                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Rank Subject </li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
								...
								<div class="row">
									<div class="col-md-12">
										<h2 class="text-danger text-center">Rank Subject</h2>
										<table class="table table-bordered" style="text-align:center;">
											...
											<?php
                                                ...
                                                $quiz = $_GET['id'];
												$sql = "select student.stud_id,student.stud_code,student.stud_name from choice inner join student on student.stud_id=choice.stud_id join question on question.q_id=choice.q_id where question.sub_quiz_id='$quiz' group by student.stud_code order by student.stud_code;";
												$result = mysqli_query($con,$sql);
							
												while($row=mysqli_fetch_assoc($result))
												{  
                                                    $sid = $row['stud_id'];
                                                   $sql1 = "select choice.result from choice inner join student on student.stud_id=choice.stud_id join question on question.q_id=choice.q_id where question.sub_quiz_id='$quiz' AND choice.stud_id='$sid';";
