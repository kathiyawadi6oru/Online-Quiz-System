        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==4) 
                {
					...
					echo '<h1>feedback</h1>';
					//echo $code;
                    $result = mysqli_query($con,"insert into feedback set name='$name',comment='$comment'") or die('Error123');
                    echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                    <tr>
						<td><center><b>student no</b></center></td>
						<input type="text" name="stud_no">
