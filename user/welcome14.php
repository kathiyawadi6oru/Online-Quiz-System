                ...
                <?php 
                    ...
                    if($rowcount == 0){*/
                        echo '<tr>
								...
								<td><center><b><a href="welcome12.php?q=result&step=3&eid='.$id.'" class="btn sub1" style="color:black;margin:0px;background:#1de9b6"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Result</b></span></a></b></center></td>
							</tr>';
